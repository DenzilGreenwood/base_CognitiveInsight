...
const YourStorySection: React.FC<YourStorySectionProps> = ({ className }) => {
  const storyItems = [
    ...
    },
    {
      ...
      description: "While encrypting data for an AI support tool, I discovered a scalable way to make AI auditable. That became the Cognitive Insight™ Audit Framework with Lazy Capsule Materialization."
    }
  ];
