...
export default function CognitiveInsightLanding() {
  ...
  const handleWhitePaper = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    submitWhitepaperLead(e);
  };
  ...
  const handleDemo = () => {
    // This could scroll to the demo section or open a modal
  ...
  return (
    <main className="min-h-screen w-full text-white bg-gradient-to-b from-indigo-900 via-slate-900 to-slate-950 selection:bg-indigo-600/40 selection:text-white">
        ...
        <div className="container mx-auto px-6 pt-20 pb-16 md:pt-28 md:pb-24 max-w-7xl">
          <div className="flex flex-col items-center text-center gap-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
              <Button onClick={handlePilot} variant="primary">
              ...
              <Button variant="ghost" onClick={() => {
                const formSection = document.getElementById('whitepaper-section');
                if (formSection) {
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 pt-8 w-full max-w-4xl">
              {[
                { label: "Storage Savings", value: `≈${Math.round(STORAGE_SAVINGS * 100)}%` },
      ...
      {/* DEMO (Simulated) */}
      <section id="demo-section" className="container mx-auto px-6 py-16 md:py-20 max-w-6xl">
        <SectionHeader
          kicker="Demo"
          title="Interactive Simulation (Demonstration Only)"
          subtitle="Results are simulated for illustration; actual performance varies by workload and environment. Verification can be performed client-side (WebCrypto) or server-side."
        />
        <div className="mt-10 grid lg:grid-cols-3 gap-6">
          <Card className="lg:col-span-2">
            ...
            <div className="mt-4 grid sm:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <p className="text-xs text-indigo-300/80 mt-2">
                  When ON, long-term storage includes expanded evidence bundles (policy-dependent)
                </p>
              </Card>
            </div>
            ...
            <div className="mt-6 flex gap-3">
              ...
              <Button variant="secondary" onClick={() => setShowPilotModal(true)}>
      ...
      {/* WHITE PAPER ACCESS */}
      <section id="whitepaper-section" className="container mx-auto px-6 py-16 md:py-20 max-w-4xl">
        <SectionHeader
          kicker="White Paper"
        ...
        <Card className="mt-8">
          ...
          >
            ...
            <p className="text-xs text-indigo-200/70 mt-2 sm:col-span-2">
              ...
              <a href="mailto:founder@CognitiveInsight.ai" className="underline ml-1">founder@CognitiveInsight.ai</a>.
            </p>
          </form>
        </Card>
      </section>
        ...
        <div role="dialog" aria-modal="true" className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
          <div className="w-full max-w-lg rounded-2xl bg-slate-900 border border-white/10 p-6">
            ...
            <form className="mt-4 space-y-3" onSubmit={submitPilot}>
              <input name="name" required placeholder="Name" className="w-full rounded-xl bg-white/10 px-4 py-2.5 text-white" />
              <input name="email" type="email" required placeholder="Work Email" className="w-full rounded-xl bg-white/10 px-4 py-2.5 text-white" />
              <input name="orgRole" placeholder="Organization & Role" className="w-full rounded-xl bg-white/10 px-4 py-2.5 text-white" />
              <input name="preferredTime" placeholder="Preferred time window (e.g., Tue 1–4pm CT)" className="w-full rounded-xl bg-white/10 px-4 py-2.5 text-white" />
              <textarea name="notes" rows={3} placeholder="What do you want to see? (e.g., model lifecycle proof, privacy constraints, regulator view)"
                className="w-full rounded-xl bg-white/10 px-4 py-2.5 text-white" />
